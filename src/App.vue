<template>
  <div class="APP">
    <div class="flex">
      ...
      <form class="w-full flex justify-center py-2 sm:p-4" @submit="fetchNew">
      ...
      <div class="w-full md:w-4/5 mb-6 p-2 sm:p-4 bg-white rounded-3xl">
        <div class="sm:p-6">
          ...
          <div class="w-full flex flex-col items-center justify-between">
           ...
           <img src="@/assets/clear.png" alt="w" class="w-48 sm:w-52" />
            </div>
            ...
            <div class="flex flex-wrap justify-around items-center w-full">
              ...
              <div class="flex items-center m-2">
                <img :src="getImage( weatherData.weather[0].main )" alt="Wind" class="w-20 mr-3  bg-slate-200  rounded-lg" />
